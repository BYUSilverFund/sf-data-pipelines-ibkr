...
def benchmark_etl_daily() -> None:
    ...
    db.execute_sql_file('pipelines/ibkr/sql/benchmark_create.sql')
    ...
    db.execute_sql_template_file('pipelines/ibkr/sql/benchmark_merge.sql', params={'stage_table': stage_table})
